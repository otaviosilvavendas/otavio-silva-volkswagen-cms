            ...
            <div className="form-panel">
              ...
              <form id="tradeForm">
                ...
                <div className="three">
                  <label>
                    Ano*
                    <input required name="ano" />
                  </label>

                  <label>
                    KM*
                    <input required name="km" />
                  </label>
                ...
                <label className="upload">
                  Fotos do veículo
                  <small>
                    Frente, traseira, laterais, interior e painel
                  </small>
        ...
        <section id="contato" className="contact">
          <div className="container contact-grid">
            ...
            <form id="leadForm" className="contact-form">
              ...
              <small>
                Ao enviar, você autoriza o contato para proposta
                e condições.
              </small>
